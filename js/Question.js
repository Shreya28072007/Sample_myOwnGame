class Question {
  ...
  display(){
    ...
    this.question.html("Question 1:- Which state produces maximum soyabean?" );
    this.question.position(300, 130);
    this.option1.html("1: Madhya Pradesh " );
    this.option1.position(300, 200);
    this.option2.html("2: Uttar Pradesh" );
    this.option2.position(300, 230);
    this.option3.html("3: Bihar " );
    this.option3.position(300, 260);
    this.option4.html("4: Rajasthan" );
    ...
    this.button.mousePressed(()=>{
      ...
      if(system.authenticate(accessCode1,this.input2.value())){
