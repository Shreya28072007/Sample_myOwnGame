class Question10 {
    ...
    display(){
      ...
      this.question.html("Question 10:- Thehead quaters of world trade organisation is in  ? " );
      this.question.position(300, 130);
      this.option1.html("1: Morteal " );
      this.option1.position(300, 200);
      this.option2.html("2: Seattle " );
      this.option2.position(300, 230);
      this.option3.html("3: Geneva" );
      this.option3.position(300, 260);
      this.option4.html("4: the Hague" );
      ...
      this.button.mousePressed(()=>{
        ...
        if(system.authenticate(accessCode10,this.input2.value())){
