class Question3 {
    ...
    display(){
      ...
      this.question.html("Question 3:- Which of the following is the capital of Arunachal Pradesh? " );
      this.question.position(300, 130);
      this.option1.html("1: Itanagar " );
      this.option1.position(300, 200);
      this.option2.html("2: Dispur" );
      this.option2.position(300, 230);
      this.option3.html("3: Imphal " );
      this.option3.position(300, 260);
      this.option4.html("4: Panaji" );
