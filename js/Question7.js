class Question7 {
    ...
    display(){
      ...
      this.question.html("Question 7:- Which of the states is not located in the north? " );
      this.question.position(300, 130);
      this.option1.html("1: Jharkhank " );
      this.option1.position(300, 200);
      this.option2.html("2: Jammu and kashmir " );
      this.option2.position(300, 230);
      this.option3.html("3: Himachal Pradesh " );
      this.option3.position(300, 260);
      this.option4.html("4: Haryana" );
    ...
    this.button2.position(750,450);
      ...
      this.button.mousePressed(()=>{
        ...
        if(system.authenticate(accessCode7,this.input2.value())){
